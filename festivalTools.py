...
def calculateDotProductForUserSearch(eventName, cityName):
...
def getTop10Festivals(festivalName, cityName):
    ...
    eventScore, bestFits = calculateEuclideanDistanceForUserSearch(festivalName, cityName)
